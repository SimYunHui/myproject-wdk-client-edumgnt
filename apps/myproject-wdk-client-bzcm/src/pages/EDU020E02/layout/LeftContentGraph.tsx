...
const LeftContentGraph = () => {
    ...
    return (
        ...
        <div style={{ width: '100%', height: '500px', marginTop:'170px', marginLeft:'30px'}}>
            <div><h5>연도별교육현황</h5></div>
            <ResponsiveBar
                /**
                 * chart에 사용될 데이터
                 */
                data={[
                    { 연도: '2020', 계획: 2512, 실적: 2645},
                    { 연도: '2021', 계획: 2375, 실적: 2122},
                    { 연도: '2022', 계획: 2611, 실적: 2711},
                ]}
                /**
